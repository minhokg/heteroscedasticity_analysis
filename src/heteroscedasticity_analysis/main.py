...
if __name__ == "__main__":
    ...
    plot_dataset(x=x, true_function=fx, observations=y, variance=sigma2, save_path="figures/Heteroscedatsticity.png")
    ...
    plot_predictions(
        ...
        save_path="figures/standard_nn.png",
    )
